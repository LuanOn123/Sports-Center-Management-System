    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
      ...
      >
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: 12, marginBottom: 14 }}>
          ...
          <span style={{ fontSize: 13, color: "#7b8982" }}>
        ...
        <div style={{ paddingTop: 18, borderTop: "1px solid #f2f5f3" }}>
          ...
          {coaches.length === 0 ? (
            <span style={{ fontSize: 13, color: "#7b8982" }}>Chưa chỉ định huấn luyện viên</span>
          ) : (
              ...
              {coaches.map((c) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 11, color: "#7b8982" }}>
                    ...
                    <div>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 14, marginTop: 4, fontSize: 13, color: "#54655d" }}>
                        <span style={{ display: "inline-flex", alignItems: "center", gap: 4 }}>
                          <MapPin size={14} color="#7b8982" />
                          Phòng: <strong>{sch.room?.name || "Sân tập"}</strong>
                        </span>
                        <span style={{ display: "inline-flex", alignItems: "center", gap: 4 }}>
                          <Users size={14} color="#7b8982" />
                          Còn trống:{" "}
                          <strong style={{ color: isFull ? "#d92d20" : "#12b76a" }}>
