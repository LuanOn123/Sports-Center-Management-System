...
import { Bell, Clock, CreditCard, Sparkles, CheckCircle, ArrowRight } from "lucide-react";
...
export function NotificationsPage() {
  ...
  const notifications = [
      ...
      ? [
          {
            ...
            message: `Gói tập của bạn còn ${daysRemaining} ngày sử dụng (hạn đến ${new Date(
              activeSub.endDate,
    ...
    ...upcomingClasses.map((item) => ({
      ...
      message: `Ca học vào lúc ${new Date(item.schedule?.startTime).toLocaleTimeString("vi-VN", {
        hour: "2-digit",
        minute: "2-digit",
      })} ngày ${new Date(item.schedule?.startTime).toLocaleDateString("vi-VN")} tại phòng ${
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline", marginBottom: 4 }}>
                  ...
                  <span style={{ fontSize: 11, color: "#98a2b3" }}>{n.time}</span>
                </div>
