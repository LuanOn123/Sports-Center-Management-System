        ...
        <div style={{ display: "flex", backgroundColor: "#f2f5f3", borderRadius: 8, padding: 3 }}>
          <button
            ...
            style={{
              ...
              color: tab === "current" ? "#203d31" : "#7b8982",
              fontWeight: 700,
              fontSize: 13,
              padding: "8px 16px",
              borderRadius: 6,
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              ...
              >
                ...
                <div>
                  ...
                  <div style={{ fontSize: 16, fontWeight: 700, marginTop: 4 }}>
                    {new Date(activeSub.startDate).toLocaleDateString("vi-VN")}
                  </div>
                </div>
                <div>
          ...
          >
            ...
            {subscriptions.length === 0 ? (
              <div style={{ color: "#7b8982", fontSize: 13 }}>Chưa có lịch sử đăng ký gói nào.</div>
            ) : (
                ...
                {subscriptions.map((sub) => (
                  ...
                  >
                    <div>
                      ...
                      <div style={{ fontSize: 12, color: "#7b8982", marginTop: 2 }}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div style={{ marginBottom: 24 }}>
                        ...
                        <span style={{ fontSize: 14, color: "#7b8982", marginLeft: 4 }}>
