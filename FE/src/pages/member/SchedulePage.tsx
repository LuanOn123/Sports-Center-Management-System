          ...
          <div style={{ display: "flex", backgroundColor: "#f2f5f3", borderRadius: 8, padding: 2 }}>
            <button
              ...
              style={{
                ...
                color: viewMode === "calendar" ? "#203d31" : "#7b8982",
                fontWeight: 600,
                fontSize: 12,
                padding: "6px 12px",
                borderRadius: 6,
            ...
            <button
              ...
              style={{
                ...
                color: viewMode === "list" ? "#203d31" : "#7b8982",
                fontWeight: 600,
                fontSize: 12,
                padding: "6px 12px",
                borderRadius: 6,
          ...
          {weekDays.map((date) => {
            ...
            return (
              ...
              >
                ...
                >
                  <div style={{ fontSize: 11, fontWeight: 700, color: isToday ? "#376228" : "#7b8982", textTransform: "uppercase" }}>
                ...
                <div style={{ padding: 8, display: "flex", flexDirection: "column", gap: 8, flex: 1 }}>
                  {dayClasses.length === 0 ? (
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", flex: 1, color: "#98a2b3", fontSize: 11 }}>
                      Nghỉ tập
                    </div>
                  ) : (
                    dayClasses.map((item) => {
